...
def run_single_month(assimilation_date):
    ...
    return unstacked_updated_mean_aao, unstacked_updated_mean_seq, unstacked_prior_mean
...
for year in range(1960, 1962):
    for month in range(1, 13):
        ...
        # Run assimilation.
        unstacked_updated_mean_aao, unstacked_updated_mean_seq, unstacked_prior_mean = run_single_month(assimilation_date)
